...
\hspace{950mm}{\color{black}$^{\dagger}$email: {pjb2132@columbia.edu} }\hspace{.25in}
...
%\vspace{.25in}
\includegraphics[width=0.8\columnwidth]{flux_surfaces_during_shaping.png}
\begin{center}
Fig. 8\\
...
%\vspace{.25in}
\begin{center}
\includegraphics[width=0.8\columnwidth]{poloidal_field_cancellation_APS_2013.png}\\
Fig. 9\\
