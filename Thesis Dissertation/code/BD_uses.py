...
(tot,topo,mag,chrono,signal,eddies,fluct,bdt) = signals(Maj_R = .92, shift = 10000,pre_time = 0,post_time = -1000)
fig = plt.figure()
plt.plot(mag,'o')
fig = plt.figure()
plt.plot(topo[:,0],'o')
...
plt.plot(t,eddies[25]+.0025)
plt.plot(t,eddies[17]+.00175)
plt.plot(t,eddies[16]+.00075)
plt.plot(t,eddies[8] +.0005)
plt.xlim(0,.02)
plt.ylim(0,.005)
plt.yticks([])
plt.xticks([])
...
plt.plot(bdt,topo[0,0]*mag[0]*chrono[0])
#plt.yticks([])
#plt.ylim(-.0005,.004)
plt.ylabel('arb. units')
plt.xticks([])
...
plt.plot(t,eddies[16]+.00075)
plt.plot(t,eddies[8] +.0005)
plt.plot(bdt,topo[25,3]*mag[3]*chrono[3]+.0025,'b')
plt.plot(bdt,topo[17,3]*mag[3]*chrono[3]+.00175,'g')
plt.plot(bdt,topo[16,3]*mag[3]*chrono[3]+.00075,'r')
plt.plot(bdt,topo[8,3]*mag[3]*chrono[3]+.0005,'c')
